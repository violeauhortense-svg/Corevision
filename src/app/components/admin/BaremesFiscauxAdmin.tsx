/**
 * 🎛️ INTERFACE D'ADMINISTRATION DES BARÈMES FISCAUX
 * 
...
export function BaremesFiscauxAdmin() {
  ...
  const handleReinitialiser = async () => {
    if (!confirm('⚠️ ATTENTION : Cette action va remplacer TOUS les barèmes par les valeurs officielles 2025 de service-public.fr.\n\nVoulez-vous continuer ?')) {
      return;
    }
